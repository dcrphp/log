...
//系统日志
$clsSystemLogger = new SystemLogger('log.php');
//配置文件 如果不用配置文件 就用下面的setConfig
...
exit;
//用户日志 只用mongodb
$clsUserLogger = new UserLogger('log_user', 'log.php');
//集合名,配置路径 格式看log.php案例 用户日志要配置好mongodb
//$clsUserLogger = new UserLogger('log_user','config.php');//使用config.php的配置
$clsUserLogger->setLogInfo(array(
